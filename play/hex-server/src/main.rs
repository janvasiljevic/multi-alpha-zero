...
use crate::hex::hex_routes::hex_routes;
use aide::{
    axum::ApiRouter,
    openapi::{OpenApi, Tag},
...
use crate::hex::hex_model_actor::{model_actor, ThinkRequest};
...
async fn main() {
    ...
    let (tx, rx) = mpsc::channel::<ThinkRequest>(32);

    tokio::spawn(model_actor(rx));
    ...
    let app = ApiRouter::new()
        .nest_api_service("/hex", hex_routes(state.clone()))
